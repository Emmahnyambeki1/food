            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" cols="55" rows="5" value="<?php echo $description; ?>" placeholder="enter your description"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="" class="text-white">price</label>
                        <input class="form-control" type="number" name="price" value="<?php echo $price; ?>" placeholder="enter your price">
                    </div>
...
if(isset($_POST['submit'])){
    ...
    if($result==true){
        ...
        $message	= base64_encode('food update successfully');
        header('location:'.SETURL. 'admin/manage.food.php?message='.$message);
    }
    else{

        $_session['update']='not updated';
        $message	= base64_encode('error updating food details');
        header('location:'.SETURL. 'admin/manage.food.php?message='.$message);
    }
}
